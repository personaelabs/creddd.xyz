...
* @returns {Uint8Array}
*/
module.exports.prove_membership = function(s_fc, s, r, is_y_odd, msg_hash, merkle_siblings, merkle_indices, root) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
module.exports.get_fc_account_sig = function(creddd_proof) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(creddd_proof, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
